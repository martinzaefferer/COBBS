...
#'
#' @param object fit of the GPR model (settings and parameters), of class \code{cobbsGPR}.
...
#'
#' @seealso \code{\link{gaussianProcessRegression}}, \code{\link{simulationDecompose}}
#' @keywords internal
###################################################################################
...
#' @references C. Lantuejoul. Geostatistical Simulation - Models and Algorithms. Springer-Verlag Berlin Heidelberg, 2002.
#'
#' @seealso \code{\link{gaussianProcessRegression}}, \code{\link{simulationSpectral}}
#' @keywords internal
###################################################################################
...
#' 
#' (Conditional) Simulation at given locations, with a model fit resulting from \code{\link{gaussianProcessRegression}}.
...
#' has a two times larger error than the GPR predictor.
#'
#' @param object fit of the GPR model (settings and parameters), of class \code{cobbsGPR}.
...
#' @export
###################################################################################
simulate.cobbsGPR <- function(object,nsim=1,seed=NA,xsim,method="decompose",conditionalSimulation=TRUE,Ncos=10,returnAll=FALSE,...){
  if (!is.na(seed)){
...
#'
#' @seealso \code{\link{simulate.cobbsGPR}}
...
#'
#' @param object an object generated by \code{\link{gaussianProcessRegression}}
...
#' 
#' @seealso \code{\link{gaussianProcessRegression}}, \code{\link{simulate.cobbsGPR}}
#' 
#' @references N. A. Cressie. Statistics for Spatial Data. JOHN WILEY & SONS INC, 1993.
#' @references C. Lantuejoul. Geostatistical Simulation - Models and Algorithms. Springer-Verlag Berlin Heidelberg, 2002.
#'
